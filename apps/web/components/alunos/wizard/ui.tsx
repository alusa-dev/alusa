...
export function SectionCard({ children }: { children: React.ReactNode }) {
  return (
    <div className="alusa-session-panel space-y-4 rounded-lg border border-slate-200 bg-white p-4 shadow-sm alusa-dark:border-[color:var(--color-border-default)] alusa-dark:bg-[color:var(--color-bg-card)]">
      {children}
    </div>
  );
}
