...
export async function getAlunoRoute(req: Request, { params }: { params: Promise<{ id: string }> }) {
...
export async function patchAlunoRoute(req: Request, { params }: { params: Promise<{ id: string }> }) {
    const rawParams = await params;
  try {
...
export async function deleteAlunoRoute(req: Request, { params }: { params: Promise<{ id: string }> }) {
    const rawParams = await params;
