...
import { formatCurrency, formatDateTime, type EventScopedResources, type TicketLotDTO, type TicketSaleDTO } from '../events-service';
  ...
  return (
    <EventPaginatedDataTable
      columns={[
        ...
        { id: 'actions', header: 'Ações', width: 'w-[10%]', align: 'right', render: (sale: TicketSaleDTO) => <TicketActions sale={sale} eventId={eventId} lots={lots} scopedResources={scopedResources} /> },
      ]}
      data={reservations}
      rowKey={(sale) => sale.id}
      loading={loading}
