...
import { formatCurrency, formatDate, type EventScopedResources, type TicketLotDTO, type TicketSaleDTO } from '../events-service';
  ...
  return (
    <EventPaginatedDataTable
      columns={[
        ...
        { id: 'actions', header: 'Ações', width: 'w-[12%]', align: 'right', render: (sale: TicketSaleDTO) => <TicketActions sale={sale} eventId={eventId} lots={lots} scopedResources={scopedResources} /> },
      ]}
      data={sales}
      rowKey={(sale) => sale.id}
      loading={loading}
