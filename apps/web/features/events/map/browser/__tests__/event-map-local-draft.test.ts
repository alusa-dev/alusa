import { getEventMapLocalDraftKey, mergeEventMapWithLocalDraft } from '@alusa/domain';
import type { EventMapDTO, EventMapDraftPayload } from '../../api/event-map-service';
import { clearEventMapLocalDraft, readEventMapLocalDraft, writeEventMapLocalDraft } from '../local-draft-storage';
