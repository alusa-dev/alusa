  ...
  return (
    <>
      ...
      <div className="absolute right-4 top-4 z-30 flex h-12 items-center gap-2 rounded-lg border border-slate-200 bg-white/95 px-1.5 shadow-lg shadow-slate-300/30 backdrop-blur">
        <Button variant="ghost" size="sm" className="hidden text-slate-700 hover:bg-slate-100 md:inline-flex">
          <Eye className="h-3.5 w-3.5" />
          Pré-visualizar
        </Button>
        <Button variant="ghost" size="sm" className="hidden text-slate-700 hover:bg-slate-100 lg:inline-flex">
