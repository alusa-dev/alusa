...
import { buildCorridorGroupRotationUpdates, buildCorridorTransformSnapshot, createCorridorGroupTransformSession, getCorridorGroupBounds } from './corridor-group-transform';
import type { CorridorGroupBounds, CorridorGroupTransformSession, CorridorTransformSnapshot } from './corridor-group-transform';
import { buildCorridorGroupResizeUpdates, computeCorridorResizeGeometry, resolveLiveCorridorGroupScale, snapshotToAabbBounds } from './corridor-group-resize';
...
import { snapCorridorGeometryAtCommit } from './corridor-snap-transform';
