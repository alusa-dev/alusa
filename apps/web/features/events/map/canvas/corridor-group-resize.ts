import { MIN_UNIFORM_SCALE, clampUniformScale, corridorWorldCenterToTopLeft, getFixedPointFromAnchor, getMovingEdgesFromAnchor, snapSmartCorridorRotation } from '@alusa/domain';
