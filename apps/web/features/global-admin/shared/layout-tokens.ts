export const GLOBAL_ADMIN_LAYOUT = {
  contentGapPx: 12,
  outerPaddingTopPx: 20,
  outerPaddingRightPx: 24,
  outerPaddingBottomPx: 24,
  outerPaddingLeftPx: 12,
  cardPaddingPx: 24,
  cardRadiusPx: 32,
  sidebarExpandedWidthPx: 262,
  sidebarCollapsedWidthPx: 64,
  cardShadow:
