...
/**
 * Eventos aceitos por POST/PUT /v3/webhooks.
 *
 * Fonte: OpenAPI oficial Asaas, consultada via MCP em 2026-08-13.
 * Manter esta lista fechada impede que payloads com eventos inexistentes
 * cheguem ao provedor e transformem o onboarding em WEBHOOK_PENDING.
 */
...
export type AsaasWebhookEventType = (typeof ASAAS_WEBHOOK_EVENTS)[number];
