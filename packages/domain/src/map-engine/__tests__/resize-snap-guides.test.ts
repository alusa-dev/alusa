import { applyResizeSnapGuides, getFixedPointFromAnchor, getMovingEdgesFromAnchor, normalizeResizeBox, resolveAnchorResizeSnap, resolveResizeSnapGuides, restoreResizeBoxSigns } from '../index';
