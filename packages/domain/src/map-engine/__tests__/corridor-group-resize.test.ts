import { constrainAabbScaleForAnchor, mapLocalScaleToAabbScale } from '../geometry/scale.js';
import { corridorEditorPolygonsIntersect } from '../layout/corridor-geometry.js';
import { buildSmartCorridorTransformPreview } from '../layout/corridor/index.js';
import {
  buildCorridorGroupResizeUpdates,
  resolveLiveCorridorGroupScale,
} from '../layout/corridor-group-resize.js';
import {
...
import { cloneEventMap } from '../layout/smart-corridor-layout.js';
...
describe('layout/corridor-group-resize', () => {
