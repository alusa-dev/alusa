import { clippingPolygonsIntersect, mergePolygons, polygonsIntersect } from '../geometry/polygon-geometry.js';
import type { EventMapObjectDTO } from '../types/event-map-types.js';
import { DEFAULT_CORRIDOR_THICKNESS } from './smart-corridor-layout.js';
import type { BoundsRect } from '../selection/selection-utils.js';

export type CorridorPolygonPoint = { x: number; y: number };

/** World-space polygon for a corridor body with top-left rotation anchor. */
