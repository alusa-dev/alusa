  ...
  "paths": {
    "/v3/webhooks/{id}": {
      "put": {
        ...
        "description": "Utilize este endpoint para atualizar informações de um webhook já cadastrado.",
              ...
              "schema": {
                ...
                "properties": {
                  ...
                  "sendType": {
                    ...
                    "x-readme-ref-name": "WebhookConfigUpdateRequestWebhookSendType"
                  },
                  "enabled": {
                    "type": "boolean",
                  ...
                  "events": {
                    "type": "array",
                    "description": "Lista dos eventos que este Webhook irá observar",
                    "example": [
                      "PAYMENT_RECEIVED",
                      "PAYMENT_CONFIRMED"
                    ],
                    ...
                    "items": {
                      ...
                      "x-readme-ref-name": "WebhookConfigUpdateRequestWebhookEvent"
                    },
                    "enum": [
                      "PAYMENT_AUTHORIZED",
                      "PAYMENT_AWAITING_RISK_ANALYSIS",
                ...
                "x-readme-ref-name": "WebhookConfigUpdateRequestDTO"
              }
            }
          }
        },
