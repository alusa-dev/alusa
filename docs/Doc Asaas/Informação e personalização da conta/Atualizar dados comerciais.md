...
> ❗️ Atenção
>
> Dependendo das informações alteradas é possível que sua conta passe por uma nova análise, o que ocasionará em um bloqueio temporário de algumas funcionalidades do sistema.
...
> ❗️ Atenção
>
> Para poder atualizar os dados comerciais, é necessário realizar o preenchimento de todas as informações abaixo. Caso não envie todas elas novamente, a requisição interpretará como `null`, alterando os dados comerciais. Ou seja, apagando os dados já preenchidos anteriormente.

<br />

> 🚧 Importante
>
> Se o **município for alterado** e houver configuração fiscal preenchida, as seguintes ações ocorrerão: as **configurações fiscais serão redefinidas**, as **NFS-e agendadas serão canceladas** e a emissão de **NFS-e nas assinaturas serão interrompidas**.
>
> Para voltar a emitir notas fiscais, será necessário reconfigurar a emissão conforme as regras do novo município.
              ...
              "schema": {
                ...
                "properties": {
                  "personType": {
                    ...
                    "x-readme-ref-name": "AccountInfoSaveRequestPersonType"
                  },
                  "cpfCnpj": {
                    "type": "string",
                  ...
                  "companyType": {
                    ...
                    "x-readme-ref-name": "AccountInfoSaveRequestCompanyType"
                  },
                  "companyName": {
                    "type": "string",
                ...
                "x-readme-ref-name": "AccountInfoSaveRequestDTO"
              }
            }
          }
        },
