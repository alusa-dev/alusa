  ...
  "paths": {
    "/v3/myAccount/documents/files/{id}": {
      "delete": {
        ...
        "summary": "Remover documento enviado",
        "description": "",
        "operationId": "remover-documento-enviado",
        "parameters": [
          {
            "name": "id",
            "in": "path",
              ...
              "application/json": {
                "schema": {
                  ...
                  "properties": {
                    "deleted": {
                      "type": "boolean",
                      "description": "Indica se o documento foi removido",
                      "example": true,
                      "deprecated": false
                    },
                    "id": {
                  ...
                  "x-readme-ref-name": "AccountDocumentDeleteResponseDTO"
                }
              }
            }
          },
